                ...
                <div className="p-0">
                  ...
                  <div className="px-6 py-5 flex flex-col gap-3 bg-blue-900/90">
                    ...
                    <div className="flex items-center justify-center gap-4 text-xs text-blue-300 mb-2">
                      <span className="flex items-center gap-1"><i className="fas fa-user"></i> {note.owner?.username}</span>
                      <span className="flex items-center gap-1"><i className="far fa-calendar-alt"></i> {new Date(note.created_at).toLocaleDateString()}</span>
                    </div>
