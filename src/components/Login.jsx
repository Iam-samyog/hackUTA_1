  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden relative">
      ...
      <div className="absolute top-6 right-6 z-20 flex items-center gap-3">
        <a
          href="/"
          className="w-12 h-12 bg-white rounded-xl shadow-lg border border-blue-100 flex items-center justify-center hover:bg-blue-50 hover:border-blue-500 transition-all hover:scale-105"
        >
          <svg
      ...
      <div
        className="absolute bottom-20 right-10 w-72 h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-blue-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-primary w-full py-4 bg-blue-600 text-white rounded-xl font-poppins font-semibold text-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
