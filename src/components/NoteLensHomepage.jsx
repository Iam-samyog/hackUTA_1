            ...
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div
                            className={`bg-white rounded-2xl p-8 shadow-lg border border-blue-100 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:border-blue-500 hover:glow-border ${isVisible.features ? 'animate-feature' : 'opacity-0'
                                }`}
                        >
                            <div
                        ...
                        {/* Feature 2 */}
                        <div
                            className={`bg-white rounded-2xl p-8 shadow-lg border border-blue-100 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:border-blue-500 hover:glow-border ${isVisible.features ? 'animate-feature delay-200' : 'opacity-0'
                                }`}
                        >
                            <div
                                className={`w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 transition-transform duration-500`}
                        ...
                        {/* Feature 3 */}
                        <div
                            className={`bg-white rounded-2xl p-8 shadow-lg border border-blue-100 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:border-blue-500 hover:glow-border ${isVisible.features ? 'animate-feature delay-400' : 'opacity-0'
                                }`}
                        >
                            <style>{`
              .glow-border {
                                ...
                                <div className="relative">
                                    <div className="w-64 h-80 bg-white rounded-2xl shadow-2xl border-4 border-blue-500 p-6 flex flex-col items-center justify-center transform hover:scale-105 transition-all duration-300">
                                        ...
                                        <p className="text-sm text-gray-600 text-center leading-relaxed">
                                            Drag or drop the file or capture picture
                                            </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={`flex flex-col items-center ${isVisible.steps ? 'animate-feature delay-300' : 'opacity-0'}`}>
                                <div className="relative">
                                    <div className="w-64 h-80 bg-white rounded-2xl shadow-2xl border-4 border-blue-500 p-6 flex flex-col items-center justify-center transform hover:scale-105 transition-all duration-300">
                                        ...
                                        <p className="text-sm text-gray-600 text-center leading-relaxed">
                                            Watch as our AI converts your notes into fully summarized and shareable notes.
                                                    </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={`flex flex-col items-center ${isVisible.steps ? 'animate-feature delay-500' : 'opacity-0'}`}>
                                <div className="relative">
                                    <div className="w-64 h-80 bg-white rounded-2xl shadow-2xl border-4 border-blue-500 p-6 flex flex-col items-center justify-center transform hover:scale-105 transition-all duration-300">
                                        ...
                                        <p className="text-sm text-gray-600 text-center leading-relaxed">
                                            Have your own social media to share the notes with others
                                            </p>
                                    </div>
                                </div>
                            </div>
